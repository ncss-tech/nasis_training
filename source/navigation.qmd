...
![](../images//2-1-refresh.png "NASIS Client NASIS menu with Refresh Local Database menu option highlighted"){fig-alt="NASIS Client NASIS menu with Refresh Local Database menu option highlighted"}

Perform the refresh on your local database and ensure it was successful. You will see a status box appear:

![](../images//2-1-refresh-steps.png "NASIS Client Refresh Local Database window"){fig-alt="NASIS Client Refresh Local Database window"}
...
![](../images//2-1-refresh-status.png "NASIS Client Status Messages window"){fig-alt="NASIS Client Status Messages window"}
...
![](../images//2-1-group.png "NASIS Client NASIS Group choice list with Basic NASIS Training Group highlighted"){fig-alt="NASIS Client NASIS Group choice list with Basic NASIS Training Group highlighted"}
...
![](../images//2-1-upload.png "NASIS Client NASIS menu with Upload All Changes to National Database option highlighted"){fig-alt="NASIS Client NASIS menu with Upload All Changes to National Database option highlighted"}
