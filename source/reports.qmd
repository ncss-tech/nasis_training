...
![](../images//excel.png "Microsoft Excel application showing the Data tab menu selected and the Text to Columns button highlighted"){fig-alt="Microsoft Excel application showing the Data tab menu selected and the Text to Columns button highlighted"}
