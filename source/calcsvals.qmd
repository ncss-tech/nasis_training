...
![](../images//8-series.png "NASIS Client Series Selection window"){fig-alt="NASIS Client Series Selection window"}
...
![](../images//8-series-status.png "NASIS Client Pedon Taxonomic History table selected showing the Taxonomic Class of a row with Tama Taxon Name"){fig-alt="NASIS Client Pedon Taxonomic History table selected showing the Taxonomic Class of a row with Tama Taxon Name"}
...
![](../images//8-current-class.png "NASIS Client Pedon table showing an empty Current Taxon Name"){fig-alt="NASIS Client Pedon table showing an empty Current Taxon Name"}
...
![](../images//8-2-val.png "NASIS Client Calculations/Validatoins tab open in the table of contents with the Pedon folder expanded showing validations"){fig-alt="NASIS Client Calculations/Validatoins tab open in the table of contents with the Pedon folder expanded showing validations"}
...
![](../images//8-2-val-results.png "NASIS Client Validations Results window containing an error message indicating Row ID 1403927 is missing the earthworms Field Measured Property"){fig-alt="NASIS Client Validations Results window containing an error message indicating Row ID 1403927 is missing the earthworms Field Measured Property"}
...
![](../images//8-3-interps.png "NASIS Client Interpretations tab selected in the table of contents showing View Primary Rules Only option is checked"){fig-alt="NASIS Client Interpretations tab selected in the table of contents showing View Primary Rules Only option is checked"}
