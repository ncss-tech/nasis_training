...
![](../images//6-import.png "NASIS Client NASIS menu with the Import GPS Site Data menu option highlighted"){fig-alt="NASIS Client NASIS menu with the Import GPS Site Data menu option highlighted"}
...
![](../images//6-file-import.png "NASIS Client Select GPX File(s) to import window with data-import.gpx highlighted"){fig-alt="NASIS Client Select GPX File(s) to import window with data-import.gpx highlighted"}

The next window shows a preview of the data which will be uploaded:

![](../images//6-import-preview.png "NASIS Client GPS Import Preview window with User Site ID S2012IA027001 highlighted"){fig-alt="NASIS Client GPS Import Preview window with User Site ID S2012IA027001 highlighted"}
...
![](../images//6-import-status.png "NASIS Client Status Messages window containing a list of sites added during the GPS data import"){fig-alt="NASIS Client Status Messages window containing a list of sites added during the GPS data import"}
